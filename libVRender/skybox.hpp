...
void _draw_skybox(const glm::mat4& vm, const glm::mat4& pm)
{
	if (ui.displayRenderDebug())
		ImGui::DragFloat("sun", &working_viewport->sun_altitude, 0.01f, 0, 1.57);

	glm::vec3 sunPosition = glm::vec3(cos(working_viewport->sun_altitude), 0.0f, sin(working_viewport->sun_altitude));
