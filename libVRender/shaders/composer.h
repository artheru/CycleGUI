...
/*
    ...
    void main()
    {
        ...
        offsets[6] = vec2(0.0, 1.0);
        offsets[7] = vec2(1.0);
        highp vec4 _180 = texture(depth_lo_res, uv);
        highp float _181 = _180.x;
        highp float dmax = _181;
        highp float dmin = _181;
        highp float param = _181;
        highp float _189 = getld(param);
        for (int i = 0; i < 8; i++)
        {
            highp vec4 _209 = texture(depth_lo_res, offsets[i] * _152 + uv);
            highp float _210 = _209.x;
            bool _212 = _210 < 1.0;
            bool _223;
            if (_212)
            {
                highp float param_1 = _210;
                _223 = abs(getld(param_1) - _189) < 0.100000001490116119384765625;
            }
            else
            {
                _223 = _212;
        ...
        highp float _239 = getld(param_3);
        dmin = _239;
        highp float fac = max(0.0, 0.4000000059604644775390625 / (pow(abs(dmax - _239), 0.800000011920928955078125) + 0.4000000059604644775390625));
        highp float dhmin = 1.0;
        for (int i_1 = 0; i_1 < 8; i_1++)
        {
            highp vec4 _274 = texture(depth_hi_res, offsets[i_1] * _145 + uv);
            highp float _275 = _274.x;
            if ((_275 > 0.0) && (_275 < 1.0))
            {
                dhmin = min(_275, dhmin);
            }
        }
        highp vec4 _291 = texture(depth_hi_res, uv);
        highp float _292 = _291.x;
        highp float param_4 = _292;
        highp float _296 = getld(param_4);
        highp float param_5 = dhmin;
        highp float _299 = getld(param_5);
        dhmin = _299;
        highp float facb = 1.0;
        if (_299 < _296)
        {
            facb = (1.0 - min((_296 - dhmin) * 2.2000000476837158203125, 1.0)) * 0.60000002384185791015625 + 0.4000000059604644775390625;
        }
        highp float _320 = min(fac, facb);
        highp float _326 = _320 - _27.reverse1;
        fac = _27.edrefl * exp((-(_326 * _326)) / (_27.reverse2 + 9.9999997473787516355514526367188e-06)) + _320;
        highp vec4 _348 = texture(uDepth, uv);
        highp float _349 = _348.x;
        if ((_349 < _292) || (!((_27.useFlag & 1) != int(0u))))
        {
            fac = 1.0;
        }
        highp float _359 = fac;
        highp float _361 = 0.800000011920928955078125 * _359 + 0.20000000298023223876953125;
        fac = _361;
        highp float _364 = frag_color.x;
        highp float _366 = frag_color.y;
        highp float _368 = frag_color.z;
        highp float _370 = max(_364, max(_366, _368));
        frag_color = vec4((((frag_color.xyz * _361) * _27.facFac) + vec3(((pow(_361, _27.fac2Fac) - 1.0) * _370) * _27.fac2WFac)) + (frag_color.xyz * _27.colorFac), frag_color.w);
        highp float darken = (texture(ssao, uv).x * _370) * 0.89999997615814208984375;
        if (_349 == _292)
        {
            darken *= 0.5;
        }
...
*/
static const char edl_composer_fs_source_glsl300es[4785] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    0x70,0x72,0x65,0x63,0x69,0x73,0x69,0x6f,0x6e,0x20,0x6d,0x65,0x64,0x69,0x75,0x6d,
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x3b,0x0a,0x70,0x72,0x65,0x63,0x69,0x73,0x69,
    ...
    0x69,0x67,0x68,0x70,0x20,0x76,0x65,0x63,0x32,0x20,0x5f,0x31,0x35,0x32,0x20,0x3d,
    ...
    0x38,0x30,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x28,0x64,0x65,0x70,
    ...
    ,
    ...
    0x76,0x65,0x63,0x34,0x20,0x5f,0x32,0x30,0x39,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,
    ...
    0x31,0x35,0x32,0x20,0x2b,0x20,0x75,0x76,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,
    0x32,0x31,0x30,0x20,0x3d,0x20,0x5f,0x32,0x30,0x39,0x2e,0x78,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x62,0x6f,0x6f,0x6c,0x20,0x5f,0x32,0x31,0x32,0x20,
    0x3d,0x20,0x5f,0x32,0x31,0x30,0x20,0x3c,0x20,0x31,0x2e,0x30,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x62,0x6f,0x6f,0x6c,0x20,0x5f,0x32,0x32,0x33,0x3b,
    ...
    0x32,0x31,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x5f,0x32,0x32,0x33,0x20,0x3d,0x20,0x61,0x62,0x73,0x28,0x67,0x65,0x74,0x6c,
    0x64,0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x31,0x29,0x20,0x2d,0x20,0x5f,0x31,0x38,
    0x39,0x29,0x20,0x3c,0x20,0x30,0x2e,0x31,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x31,
    ...
    0x20,0x5f,0x32,0x32,0x33,0x20,0x3d,0x20,0x5f,0x32,0x31,0x32,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x7d,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x69,0x66,0x20,0x28,0x5f,0x32,0x32,0x33,0x29,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x7b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x64,0x6d,0x61,0x78,0x20,0x3d,0x20,0x6d,0x61,0x78,0x28,0x5f,0x32,0x31,0x30,0x2c,
    ...
    0x32,0x31,0x30,0x2c,0x20,0x64,0x6d,0x69,0x6e,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,
    ...
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x32,0x33,0x39,0x20,0x3d,0x20,0x67,0x65,
    0x74,0x6c,0x64,0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x33,0x29,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x64,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x5f,0x32,0x33,0x39,0x3b,0x0a,0x20,
    ...
    0x28,0x61,0x62,0x73,0x28,0x64,0x6d,0x61,0x78,0x20,0x2d,0x20,0x5f,0x32,0x33,0x39,
    ...
    0x2b,0x29,0x0a,0x20,0x20,0x20,0x20,0x7b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x32,0x37,0x34,
    ...
    0x5b,0x69,0x5f,0x31,0x5d,0x20,0x2a,0x20,0x5f,0x31,0x34,0x35,0x20,0x2b,0x20,0x75,
    0x76,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x32,0x37,0x35,0x20,0x3d,0x20,0x5f,
    0x32,0x37,0x34,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x69,
    0x66,0x20,0x28,0x28,0x5f,0x32,0x37,0x35,0x20,0x3e,0x20,0x30,0x2e,0x30,0x29,0x20,
    0x26,0x26,0x20,0x28,0x5f,0x32,0x37,0x35,0x20,0x3c,0x20,0x31,0x2e,0x30,0x29,0x29,
    ...
    0x69,0x6e,0x28,0x5f,0x32,0x37,0x35,0x2c,0x20,0x64,0x68,0x6d,0x69,0x6e,0x29,0x3b,
    ...
    ,
    ...
    0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x32,0x39,0x39,0x20,0x3d,0x20,
    0x67,0x65,0x74,0x6c,0x64,0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x35,0x29,0x3b,0x0a,
    0x20,0x20,0x20,0x20,0x64,0x68,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x5f,0x32,0x39,0x39,
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,
    0x74,0x20,0x66,0x61,0x63,0x62,0x20,0x3d,0x20,0x31,0x2e,0x30,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x69,0x66,0x20,0x28,0x5f,0x32,0x39,0x39,0x20,0x3c,0x20,0x5f,0x32,0x39,
    ...
    0x69,0x6e,0x28,0x28,0x5f,0x32,0x39,0x36,0x20,0x2d,0x20,0x64,0x68,0x6d,0x69,0x6e,
    ...
    0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x32,0x30,0x20,0x3d,0x20,0x6d,0x69,0x6e,0x28,
    0x66,0x61,0x63,0x2c,0x20,0x66,0x61,0x63,0x62,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,
    0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x32,0x36,
    0x20,0x3d,0x20,0x5f,0x33,0x32,0x30,0x20,0x2d,0x20,0x5f,0x32,0x37,0x2e,0x72,0x65,
    ...
    0x78,0x70,0x28,0x28,0x2d,0x28,0x5f,0x33,0x32,0x36,0x20,0x2a,0x20,0x5f,0x33,0x32,
    0x36,0x29,0x29,0x20,0x2f,0x20,0x28,0x5f,0x32,0x37,0x2e,0x72,0x65,0x76,0x65,0x72,
    ...
    0x5f,0x33,0x32,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,
    0x76,0x65,0x63,0x34,0x20,0x5f,0x33,0x34,0x38,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,
    0x75,0x72,0x65,0x28,0x75,0x44,0x65,0x70,0x74,0x68,0x2c,0x20,0x75,0x76,0x29,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,
    0x20,0x5f,0x33,0x34,0x39,0x20,0x3d,0x20,0x5f,0x33,0x34,0x38,0x2e,0x78,0x3b,0x0a,
    0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x28,0x5f,0x33,0x34,0x39,0x20,0x3c,0x20,
    0x5f,0x32,0x39,0x32,0x29,0x20,0x7c,0x7c,0x20,0x28,0x21,0x28,0x28,0x5f,0x32,0x37,
    ...
    0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x35,0x39,0x20,
    0x3d,0x20,0x66,0x61,0x63,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x36,0x31,0x20,0x3d,0x20,0x30,0x2e,
    0x38,0x30,0x30,0x30,0x30,0x30,0x30,0x31,0x31,0x39,0x32,0x30,0x39,0x32,0x38,0x39,
    0x35,0x35,0x30,0x37,0x38,0x31,0x32,0x35,0x20,0x2a,0x20,0x5f,0x33,0x35,0x39,0x20,
    ...
    ,
    ...
    0x63,0x6f,0x6c,0x6f,0x72,0x2e,0x78,0x79,0x7a,0x20,0x2a,0x20,0x5f,0x33,0x36,0x31,
    0x29,0x20,0x2a,0x20,0x5f,0x32,0x37,0x2e,0x66,0x61,0x63,0x46,0x61,0x63,0x29,0x20,
    0x2b,0x20,0x76,0x65,0x63,0x33,0x28,0x28,0x28,0x70,0x6f,0x77,0x28,0x5f,0x33,0x36,
    0x31,0x2c,0x20,0x5f,0x32,0x37,0x2e,0x66,0x61,0x63,0x32,0x46,0x61,0x63,0x29,0x20,
    0x2d,0x20,0x31,0x2e,0x30,0x29,0x20,0x2a,0x20,0x5f,0x33,0x37,0x30,0x29,0x20,0x2a,
    ...
    0x2a,0x20,0x5f,0x33,0x37,0x30,0x29,0x20,0x2a,0x20,0x30,0x2e,0x38,0x39,0x39,0x39,
    0x39,0x39,0x39,0x37,0x36,0x31,0x35,0x38,0x31,0x34,0x32,0x30,0x38,0x39,0x38,0x34,
    0x33,0x37,0x35,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x5f,0x33,0x34,
    0x39,0x20,0x3d,0x3d,0x20,0x5f,0x32,0x39,0x32,0x29,0x0a,0x20,0x20,0x20,0x20,0x7b,
