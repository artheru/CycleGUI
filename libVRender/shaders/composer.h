...
/*
    ...
    void main()
    {
        ...
        if ((_27.useFlag & 8) != 0)
        {
            highp vec4 _81 = texture(wboit_composed, uv);
            highp vec4 _86 = texture(wboit_reveal, uv);
            highp float _89 = _86.x;
            color = vec4((color.xyz * (1.0 - _89)) + (_81.xyz * _89), max(color.w, _81.w));
        }
        frag_color = color;
        highp vec2 _146 = vec2(1.0) / vec2(textureSize(depth_hi_res, 0));
        highp vec2 _153 = vec2(1.0) / vec2(textureSize(depth_lo_res, 0));
        highp vec2 offsets[8];
        offsets[0] = vec2(-1.0);
        offsets[1] = vec2(0.0, -1.0);
        offsets[2] = vec2(1.0, -1.0);
        ...
        offsets[6] = vec2(0.0, 1.0);
        offsets[7] = vec2(1.0);
        highp vec4 _181 = texture(depth_lo_res, uv);
        highp float _182 = _181.x;
        highp float dmax = _182;
        highp float dmin = _182;
        highp float param = _182;
        highp float _190 = getld(param);
        for (int i = 0; i < 8; i++)
        {
            highp vec4 _210 = texture(depth_lo_res, offsets[i] * _153 + uv);
            highp float _211 = _210.x;
            bool _213 = _211 < 1.0;
            bool _224;
            if (_213)
            {
                highp float param_1 = _211;
                _224 = abs(getld(param_1) - _190) < 0.100000001490116119384765625;
            }
            else
            {
                _224 = _213;
        ...
        highp float _240 = getld(param_3);
        dmin = _240;
        highp float fac = max(0.0, 0.4000000059604644775390625 / (pow(abs(dmax - _240), 0.800000011920928955078125) + 0.4000000059604644775390625));
        highp float dhmin = 1.0;
        for (int i_1 = 0; i_1 < 8; i_1++)
        {
            highp vec4 _275 = texture(depth_hi_res, offsets[i_1] * _146 + uv);
            highp float _276 = _275.x;
            if ((_276 > 0.0) && (_276 < 1.0))
            {
                dhmin = min(_276, dhmin);
            }
        }
        highp vec4 _292 = texture(depth_hi_res, uv);
        highp float _293 = _292.x;
        highp float param_4 = _293;
        highp float _297 = getld(param_4);
        highp float param_5 = dhmin;
        highp float _300 = getld(param_5);
        dhmin = _300;
        highp float facb = 1.0;
        if (_300 < _297)
        {
            facb = (1.0 - min((_297 - dhmin) * 2.2000000476837158203125, 1.0)) * 0.60000002384185791015625 + 0.4000000059604644775390625;
        }
        highp float _321 = min(fac, facb);
        highp float _327 = _321 - _27.reverse1;
        fac = _27.edrefl * exp((-(_327 * _327)) / (_27.reverse2 + 9.9999997473787516355514526367188e-06)) + _321;
        highp vec4 _349 = texture(uDepth, uv);
        highp float _350 = _349.x;
        if ((_350 < _293) || (!((_27.useFlag & 1) != int(0u))))
        {
            fac = 1.0;
        }
        highp float _360 = fac;
        highp float _362 = 0.800000011920928955078125 * _360 + 0.20000000298023223876953125;
        fac = _362;
        highp float _366 = frag_color.x;
        highp float _368 = frag_color.y;
        highp float _370 = frag_color.z;
        highp float _372 = max(_366, max(_368, _370));
        frag_color = vec4((((frag_color.xyz * _362) * _27.facFac) + vec3(((pow(_362, _27.fac2Fac) - 1.0) * _372) * _27.fac2WFac)) + (frag_color.xyz * _27.colorFac), frag_color.w);
        highp float darken = (texture(ssao, uv).x * _372) * 0.89999997615814208984375;
        if (_350 == _293)
        {
            darken *= 0.5;
        }
...
*/
static const char edl_composer_fs_source_glsl300es[4692] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    0x70,0x72,0x65,0x63,0x69,0x73,0x69,0x6f,0x6e,0x20,0x6d,0x65,0x64,0x69,0x75,0x6d,
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x3b,0x0a,0x70,0x72,0x65,0x63,0x69,0x73,0x69,
    ...
    ,
    ...
    0x70,0x20,0x76,0x65,0x63,0x32,0x20,0x5f,0x31,0x34,0x36,0x20,0x3d,0x20,0x76,0x65,
    ...
    0x20,0x5f,0x31,0x38,0x31,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x28,
    ...
    ,
    ...
    0x68,0x70,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x32,0x31,0x30,0x20,0x3d,0x20,0x74,
    ...
    ,
    ...
    0x3d,0x20,0x5f,0x32,0x31,0x31,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x5f,0x32,0x32,0x34,0x20,0x3d,0x20,0x61,0x62,0x73,0x28,0x67,
    0x65,0x74,0x6c,0x64,0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x31,0x29,0x20,0x2d,0x20,
    0x5f,0x31,0x39,0x30,0x29,0x20,0x3c,0x20,0x30,0x2e,0x31,0x30,0x30,0x30,0x30,0x30,
    ...
    0x20,0x20,0x20,0x20,0x5f,0x32,0x32,0x34,0x20,0x3d,0x20,0x5f,0x32,0x31,0x33,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x7d,0x0a,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x5f,0x32,0x32,0x34,0x29,0x0a,0x20,0x20,0x20,
    ...
    0x31,0x31,0x2c,0x20,0x64,0x6d,0x61,0x78,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x64,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x6d,0x69,
    0x6e,0x28,0x5f,0x32,0x31,0x31,0x2c,0x20,0x64,0x6d,0x69,0x6e,0x29,0x3b,0x0a,0x20,
    ...
    0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x32,0x34,0x30,0x20,0x3d,
    0x20,0x67,0x65,0x74,0x6c,0x64,0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x33,0x29,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x64,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x5f,0x32,0x34,0x30,
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,
    ...
    0x32,0x34,0x30,0x29,0x2c,0x20,0x30,0x2e,0x38,0x30,0x30,0x30,0x30,0x30,0x30,0x31,
    ...
    0x32,0x37,0x35,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x28,0x64,0x65,
    0x70,0x74,0x68,0x5f,0x68,0x69,0x5f,0x72,0x65,0x73,0x2c,0x20,0x6f,0x66,0x66,0x73,
    0x65,0x74,0x73,0x5b,0x69,0x5f,0x31,0x5d,0x20,0x2a,0x20,0x5f,0x31,0x34,0x36,0x20,
    ...
    0x3d,0x20,0x5f,0x32,0x37,0x35,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x69,0x66,0x20,0x28,0x28,0x5f,0x32,0x37,0x36,0x20,0x3e,0x20,0x30,0x2e,
    0x30,0x29,0x20,0x26,0x26,0x20,0x28,0x5f,0x32,0x37,0x36,0x20,0x3c,0x20,0x31,0x2e,
    ...
    0x3d,0x20,0x6d,0x69,0x6e,0x28,0x5f,0x32,0x37,0x36,0x2c,0x20,0x64,0x68,0x6d,0x69,
    ...
    0x63,0x34,0x20,0x5f,0x32,0x39,0x32,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,
    ...
    0x6f,0x61,0x74,0x20,0x5f,0x32,0x39,0x37,0x20,0x3d,0x20,0x67,0x65,0x74,0x6c,0x64,
    ...
    0x33,0x30,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,
    0x6c,0x6f,0x61,0x74,0x20,0x66,0x61,0x63,0x62,0x20,0x3d,0x20,0x31,0x2e,0x30,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x5f,0x33,0x30,0x30,0x20,0x3c,0x20,
    0x5f,0x32,0x39,0x37,0x29,0x0a,0x20,0x20,0x20,0x20,0x7b,0x0a,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x66,0x61,0x63,0x62,0x20,0x3d,0x20,0x28,0x31,0x2e,0x30,0x20,
    0x2d,0x20,0x6d,0x69,0x6e,0x28,0x28,0x5f,0x32,0x39,0x37,0x20,0x2d,0x20,0x64,0x68,
    ...
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x32,0x31,0x20,0x3d,0x20,0x6d,
    ...
    0x33,0x32,0x37,0x20,0x3d,0x20,0x5f,0x33,0x32,0x31,0x20,0x2d,0x20,0x5f,0x32,0x37,
    ...
    0x2a,0x20,0x65,0x78,0x70,0x28,0x28,0x2d,0x28,0x5f,0x33,0x32,0x37,0x20,0x2a,0x20,
    0x5f,0x33,0x32,0x37,0x29,0x29,0x20,0x2f,0x20,0x28,0x5f,0x32,0x37,0x2e,0x72,0x65,
    ...
    0x20,0x2b,0x20,0x5f,0x33,0x32,0x31,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,
    0x68,0x70,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x33,0x34,0x39,0x20,0x3d,0x20,0x74,
    ...
    0x6f,0x61,0x74,0x20,0x5f,0x33,0x35,0x30,0x20,0x3d,0x20,0x5f,0x33,0x34,0x39,0x2e,
    0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x28,0x5f,0x33,0x35,0x30,
    0x20,0x3c,0x20,0x5f,0x32,0x39,0x33,0x29,0x20,0x7c,0x7c,0x20,0x28,0x21,0x28,0x28,
    ...
    0x36,0x30,0x20,0x3d,0x20,0x66,0x61,0x63,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,
    ...
    0x36,0x30,0x20,0x2b,0x20,0x30,0x2e,0x32,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x32,
    0x39,0x38,0x30,0x32,0x33,0x32,0x32,0x33,0x38,0x37,0x36,0x39,0x35,0x33,0x31,0x32,
    0x35,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x61,0x63,0x20,0x3d,0x20,0x5f,0x33,0x36,
    0x32,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,
    0x61,0x74,0x20,0x5f,0x33,0x36,0x36,0x20,0x3d,0x20,0x66,0x72,0x61,0x67,0x5f,0x63,
    0x6f,0x6c,0x6f,0x72,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,0x36,0x38,0x20,0x3d,0x20,0x66,
    ...
    0x30,0x20,0x3d,0x20,0x66,0x72,0x61,0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x2e,0x7a,
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,0x61,
    0x74,0x20,0x5f,0x33,0x37,0x32,0x20,0x3d,0x20,0x6d,0x61,0x78,0x28,0x5f,0x33,0x36,
    0x36,0x2c,0x20,0x6d,0x61,0x78,0x28,0x5f,0x33,0x36,0x38,0x2c,0x20,0x5f,0x33,0x37,
    ...
    0x33,0x36,0x32,0x29,0x20,0x2a,0x20,0x5f,0x32,0x37,0x2e,0x66,0x61,0x63,0x46,0x61,
    0x63,0x29,0x20,0x2b,0x20,0x76,0x65,0x63,0x33,0x28,0x28,0x28,0x70,0x6f,0x77,0x28,
    0x5f,0x33,0x36,0x32,0x2c,0x20,0x5f,0x32,0x37,0x2e,0x66,0x61,0x63,0x32,0x46,0x61,
    0x63,0x29,0x20,0x2d,0x20,0x31,0x2e,0x30,0x29,0x20,0x2a,0x20,0x5f,0x33,0x37,0x32,
    ...
    0x2e,0x78,0x20,0x2a,0x20,0x5f,0x33,0x37,0x32,0x29,0x20,0x2a,0x20,0x30,0x2e,0x38,
    ...
    0x5f,0x33,0x35,0x30,0x20,0x3d,0x3d,0x20,0x5f,0x32,0x39,0x33,0x29,0x0a,0x20,0x20,
