...
/*
    ...
    void main()
    {
        ...
        if ((_27.useFlag & 8) != 0)
        {
            highp vec4 _88 = texture(wboit_reveal, uv);
            highp float _91 = _88.x;
            color = vec4((color.xyz * (1.0 - _91)) + (texture(wboit_composed, uv).xyz * _91), max(color.w, _91));
        }
        frag_color = color;
        highp vec2 _143 = vec2(1.0) / vec2(textureSize(depth_hi_res, 0));
        highp vec2 _150 = vec2(1.0) / vec2(textureSize(depth_lo_res, 0));
        highp vec2 offsets[8];
        offsets[0] = vec2(-1.0);
        offsets[1] = vec2(0.0, -1.0);
        offsets[2] = vec2(1.0, -1.0);
        ...
        offsets[6] = vec2(0.0, 1.0);
        offsets[7] = vec2(1.0);
        highp vec4 _178 = texture(depth_lo_res, uv);
        highp float _179 = _178.x;
        highp float dmax = _179;
        highp float dmin = _179;
        highp float param = _179;
        highp float _187 = getld(param);
        for (int i = 0; i < 8; i++)
        {
            highp vec4 _207 = texture(depth_lo_res, offsets[i] * _150 + uv);
            highp float _208 = _207.x;
            bool _210 = _208 < 1.0;
            bool _221;
            if (_210)
            {
                highp float param_1 = _208;
                _221 = abs(getld(param_1) - _187) < 0.100000001490116119384765625;
            }
            else
            {
                _221 = _210;
        ...
        highp float _237 = getld(param_3);
        dmin = _237;
        highp float fac = max(0.0, 0.4000000059604644775390625 / (pow(abs(dmax - _237), 0.800000011920928955078125) + 0.4000000059604644775390625));
        highp float dhmin = 1.0;
        for (int i_1 = 0; i_1 < 8; i_1++)
        {
            highp vec4 _272 = texture(depth_hi_res, offsets[i_1] * _143 + uv);
            highp float _273 = _272.x;
            if ((_273 > 0.0) && (_273 < 1.0))
            {
                dhmin = min(_273, dhmin);
            }
        }
        highp vec4 _289 = texture(depth_hi_res, uv);
        highp float _290 = _289.x;
        highp float param_4 = _290;
        highp float _294 = getld(param_4);
        highp float param_5 = dhmin;
        highp float _297 = getld(param_5);
        dhmin = _297;
        highp float facb = 1.0;
        if (_297 < _294)
        {
            facb = (1.0 - min((_294 - dhmin) * 2.2000000476837158203125, 1.0)) * 0.60000002384185791015625 + 0.4000000059604644775390625;
        }
        highp float _318 = min(fac, facb);
        highp float _324 = _318 - _27.reverse1;
        fac = _27.edrefl * exp((-(_324 * _324)) / (_27.reverse2 + 9.9999997473787516355514526367188e-06)) + _318;
        highp vec4 _346 = texture(uDepth, uv);
        highp float _347 = _346.x;
        if ((_347 < _290) || (!((_27.useFlag & 1) != int(0u))))
        {
            fac = 1.0;
        }
        highp float _357 = fac;
        highp float _359 = 0.800000011920928955078125 * _357 + 0.20000000298023223876953125;
        fac = _359;
        highp float _363 = frag_color.x;
        highp float _366 = frag_color.y;
        highp float _369 = frag_color.z;
        highp float _371 = max(_363, max(_366, _369));
        frag_color = vec4((((frag_color.xyz * _359) * _27.facFac) + vec3(((pow(_359, _27.fac2Fac) - 1.0) * _371) * _27.fac2WFac)) + (frag_color.xyz * _27.colorFac), frag_color.w);
        highp float darken = (texture(ssao, uv).x * _371) * 0.89999997615814208984375;
        if (_347 == _290)
        {
            darken *= 0.5;
        }
...
*/
static const char edl_composer_fs_source_glsl300es[4660] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    0x70,0x72,0x65,0x63,0x69,0x73,0x69,0x6f,0x6e,0x20,0x6d,0x65,0x64,0x69,0x75,0x6d,
    0x70,0x20,0x66,0x6c,0x6f,0x61,0x74,0x3b,0x0a,0x70,0x72,0x65,0x63,0x69,0x73,0x69,
    ...
    0x69,0x67,0x68,0x70,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x38,0x38,0x20,0x3d,0x20,
    ...
    ,
    ...
    0x70,0x20,0x76,0x65,0x63,0x32,0x20,0x5f,0x31,0x34,0x33,0x20,0x3d,0x20,0x76,0x65,
    ...
    0x30,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x28,0x31,0x2e,0x30,0x29,0x20,0x2f,0x20,
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    0x20,0x20,0x20,0x64,0x6d,0x61,0x78,0x20,0x3d,0x20,0x6d,0x61,0x78,0x28,0x5f,0x32,
    0x30,0x38,0x2c,0x20,0x64,0x6d,0x61,0x78,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x64,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x6d,0x69,
    0x6e,0x28,0x5f,0x32,0x30,0x38,0x2c,0x20,0x64,0x6d,0x69,0x6e,0x29,0x3b,0x0a,0x20,
    ...
    0x61,0x72,0x61,0x6d,0x5f,0x32,0x20,0x3d,0x20,0x64,0x6d,0x61,0x78,0x3b,0x0a,0x20,
    0x20,0x20,0x20,0x64,0x6d,0x61,0x78,0x20,0x3d,0x20,0x67,0x65,0x74,0x6c,0x64,0x28,
    ...
    ,
    ...
    0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,0x68,0x70,0x20,0x66,0x6c,0x6f,
    0x61,0x74,0x20,0x64,0x68,0x6d,0x69,0x6e,0x20,0x3d,0x20,0x31,0x2e,0x30,0x3b,0x0a,
    0x20,0x20,0x20,0x20,0x66,0x6f,0x72,0x20,0x28,0x69,0x6e,0x74,0x20,0x69,0x5f,0x31,
    0x20,0x3d,0x20,0x30,0x3b,0x20,0x69,0x5f,0x31,0x20,0x3c,0x20,0x38,0x3b,0x20,0x69,
    ...
    ,
    ...
    0x6c,0x6f,0x61,0x74,0x20,0x5f,0x32,0x39,0x30,0x20,0x3d,0x20,0x5f,0x32,0x38,0x39,
    ...
    ,
    ...
    ,
    ...
    0x20,0x2b,0x20,0x5f,0x33,0x31,0x38,0x3b,0x0a,0x20,0x20,0x20,0x20,0x68,0x69,0x67,
    0x68,0x70,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x33,0x34,0x36,0x20,0x3d,0x20,0x74,
    ...
    0x6f,0x61,0x74,0x20,0x5f,0x33,0x34,0x37,0x20,0x3d,0x20,0x5f,0x33,0x34,0x36,0x2e,
    0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x28,0x5f,0x33,0x34,0x37,
    0x20,0x3c,0x20,0x5f,0x32,0x39,0x30,0x29,0x20,0x7c,0x7c,0x20,0x28,0x21,0x28,0x28,
    0x5f,0x32,0x37,0x2e,0x75,0x73,0x65,0x46,0x6c,0x61,0x67,0x20,0x26,0x20,0x31,0x29,
    0x20,0x21,0x3d,0x20,0x69,0x6e,0x74,0x28,0x30,0x75,0x29,0x29,0x29,0x29,0x0a,0x20,
    ...
    ,
    ...
    0x5f,0x33,0x34,0x37,0x20,0x3d,0x3d,0x20,0x5f,0x32,0x39,0x30,0x29,0x0a,0x20,0x20,
    ...
    0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x21,0x28,0x28,0x5f,0x32,0x37,0x2e,
    0x75,0x73,0x65,0x46,0x6c,0x61,0x67,0x20,0x26,0x20,0x32,0x29,0x20,0x21,0x3d,0x20,
    0x69,0x6e,0x74,0x28,0x30,0x75,0x29,0x29,0x29,0x0a,0x20,0x20,0x20,0x20,0x7b,0x0a,
    0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x64,0x61,0x72,0x6b,0x65,0x6e,0x20,0x3d,
    ...
    0x20,0x2d,0x20,0x76,0x65,0x63,0x33,0x28,0x64,0x61,0x72,0x6b,0x65,0x6e,0x29,0x2c,
