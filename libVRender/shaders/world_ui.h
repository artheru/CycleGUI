...
#define ATTR_txt_quad_vs_Iquat (1)
...
/*
    ...
    layout(location = 1) in vec4 Iquat;
    
    vec3 quat_rotate(vec4 q, vec3 v)
    {
        return v + (cross(q.xyz, cross(q.xyz, v) + (v * q.w)) * 2.0);
    }
    
    void main()
    {
        float _49 = float(gl_VertexID % 2);
        float _53 = float(gl_VertexID / 2);
        ...
        if ((flag & 32) != 0)
        {
            vec4 _117 = mat4(txt_quad_params[0], txt_quad_params[1], txt_quad_params[2], txt_quad_params[3]) * vec4(Iposition, 1.0);
            float _135 = (Iuv_max.x - Iuv_min.x) / ((Iglyph_xy.z - Iglyph_xy.x) / bbox.x);
            float _146 = Iuv_min.x - ((_135 * Iglyph_xy.x) / bbox.x);
            float _161 = (Iuv_min.y - Iuv_max.y) / ((Iglyph_xy.w - Iglyph_xy.y) / bbox.y);
            float _172 = Iuv_max.y - ((_161 * Iglyph_xy.y) / bbox.y);
            if ((flag & 64) != 0)
            {
                float yk = _53;
                bool _182 = gl_VertexID == 0;
                if (_182)
                {
                    yk = -0.300000011920928955078125;
                }
                uv = vec2(_135, _161) * vec2(_49, yk) + vec2(_146, _172);
                float yy = _53 + 0.300000011920928955078125;
                if (_182)
                {
                    yy = 0.0;
                }
                gl_Position = _117 + vec4((((Isize * vec2(_49, yy)) / vec2(txt_quad_params[4].y, txt_quad_params[4].z)) * 2.0) * _117.w, 0.0, 0.0);
            }
            else
            {
                vec2 _246 = vec2(_49, _53);
                uv = vec2(_135, _161) * _246 + vec2(_146, _172);
                gl_Position = _117 + vec4((((Isize * (_246 - vec2(0.5))) / vec2(txt_quad_params[4].y, txt_quad_params[4].z)) * 2.0) * _117.w, 0.0, 0.0);
            }
        }
        else
        {
            vec4 param = Iquat;
            vec3 param_1 = vec3(_49, _53, 0.0);
            gl_Position = mat4(txt_quad_params[0], txt_quad_params[1], txt_quad_params[2], txt_quad_params[3]) * vec4(Iposition + quat_rotate(param, param_1), 1.0);
        }
    }
    
*/
static const char txt_quad_vs_source_glsl300es[2524] = {
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    0x75,0x76,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x28,0x5f,0x31,0x33,0x35,0x2c,0x20,
    0x5f,0x31,0x36,0x31,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,0x32,0x28,0x5f,0x34,0x39,
    0x2c,0x20,0x79,0x6b,0x29,0x20,0x2b,0x20,0x76,0x65,0x63,0x32,0x28,0x5f,0x31,0x34,
    0x36,0x2c,0x20,0x5f,0x31,0x37,0x32,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x79,0x79,0x20,0x3d,
    0x20,0x5f,0x35,0x33,0x20,0x2b,0x20,0x30,0x2e,0x33,0x30,0x30,0x30,0x30,0x30,0x30,
    ...
    0x66,0x20,0x28,0x5f,0x31,0x38,0x32,0x29,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x7b,0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,
    0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x79,0x79,0x20,0x3d,0x20,0x30,0x2e,0x30,0x3b,
    ...
    ,
    ...
    ,
    ...
    0x32,0x2e,0x30,0x29,0x20,0x2a,0x20,0x5f,0x31,0x31,0x37,0x2e,0x77,0x2c,0x20,0x30,
    ...
    ,
