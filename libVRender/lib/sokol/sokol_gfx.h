...
#define _SG_LOG_ITEMS \
    ...
    _SG_LOGITEM_XMACRO(VALIDATE_BUFFERDESC_SIZE, "sg_\buffer_desc.size and .data.size cannot both be 0") \
...
#pragma warning(disable:4055)   /* 'type cast': from data pointer */
    ...
    #endif
    #define _SG_GL_CHECK_ERROR() ; // SOKOL_ASSERT(glGetError() == GL_NO_ERROR); } skip error checking...
#endif
...
enum {
    ...
    _SG_DEFAULT_SHADER_POOL_SIZE = 64,
    _SG_DEFAULT_PIPELINE_POOL_SIZE = 64,
    _SG_DEFAULT_PASS_POOL_SIZE = 32,
