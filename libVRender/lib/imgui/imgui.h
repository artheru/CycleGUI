...
struct ImGuiStyle
{
    ...
    ImVec2 imstyleWindowPaddingDSed() const;
    float     imstyleWindowRoundingDSed()const;
    ImVec2     imstyleWindowMinSizeDSed()const;
    float     imstyleChildRoundingDSed()const;
    float     imstylePopupRoundingDSed()const;
    ImVec2 imstyleFramePaddingDSed()const;
    float imstyleFrameRoundingDSed()const;
    ImVec2 imstyleItemSpacingDSed()const;
    ImVec2 imstyleItemInnerSpacingDSed()const;
    ImVec2 imstyleCellPaddingDSed()const;
    ImVec2 imstyleTouchExtraPaddingDSed()const;
    float imstyleIndentSpacingDSed()const;
    float imstyleColumnsMinSpacingDSed()const;
    float imstyleScrollbarSizeDSed()const;
    float imstyleScrollbarRoundingDSed()const;
    float imstyleGrabMinSizeDSed()const;
    float imstyleGrabRoundingDSed()const;
    float imstyleLogSliderDeadzoneDSed()const;
    float imstyleTabRoundingDSed()const;
    ImVec2 imstyleSeparatorTextPaddingDSed()const;
...
#define imstyleWindowPadding CONCATENATE(imstyleWindowPadding, DSed)()
#define imstyleWindowRounding CONCATENATE(imstyleWindowRounding, DSed)()
#define imstyleWindowMinSize CONCATENATE(imstyleWindowMinSize, DSed)()
#define imstyleChildRounding CONCATENATE(imstyleChildRounding, DSed)()
#define imstylePopupRounding CONCATENATE(imstylePopupRounding, DSed)()
#define imstyleFramePadding CONCATENATE(imstyleFramePadding, DSed)()
#define imstyleFrameRounding CONCATENATE(imstyleFrameRounding, DSed)()
#define imstyleItemSpacing CONCATENATE(imstyleItemSpacing, DSed)()
#define imstyleItemInnerSpacing CONCATENATE(imstyleItemInnerSpacing, DSed)()
#define imstyleCellPadding CONCATENATE(imstyleCellPadding, DSed)()
#define imstyleTouchExtraPadding CONCATENATE(imstyleTouchExtraPadding, DSed)()
#define imstyleIndentSpacing CONCATENATE(imstyleIndentSpacing, DSed)()
#define imstyleColumnsMinSpacing CONCATENATE(imstyleColumnsMinSpacing, DSed)()
#define imstyleScrollbarSize CONCATENATE(imstyleScrollbarSize, DSed)()
#define imstyleScrollbarRounding CONCATENATE(imstyleScrollbarRounding, DSed)()
#define imstyleGrabMinSize CONCATENATE(imstyleGrabMinSize, DSed)()
#define imstyleGrabRounding CONCATENATE(imstyleGrabRounding, DSed)()
#define imstyleLogSliderDeadzone CONCATENATE(imstyleLogSliderDeadzone, DSed)()
#define imstyleTabRounding CONCATENATE(imstyleTabRounding, DSed)()
#define imstyleSeparatorTextPadding CONCATENATE(imstyleSeparatorTextPadding, DSed)()
