...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'D:/src/CycleGUI/Emscripten/WebDebug/webVRender.data';
      var REMOTE_PACKAGE_BASE = 'webVRender.data';
...
Module['FS_createPath']("/", "data", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_D:/src/CycleGUI/Emscripten/WebDebug/webVRender.data');

      };
      Module['addRunDependency']('datafile_D:/src/CycleGUI/Emscripten/WebDebug/webVRender.data');
    ...
    loadPackage({"files": [{"filename": "/data/ZCOOLQingKeHuangYou-Regular.ttf", "start": 0, "end": 8312296}, {"filename": "/data/forkawesome-webfont.ttf", "start": 8312296, "end": 8531300}], "remote_package_size": 8531300});
...
var wasmBinaryFile;
  wasmBinaryFile = 'webVRender.wasm';
...
function melog(c_str) { const str = UTF8ToString(c_str);console.log(str); }
function logging(c_str) { const str = UTF8ToString(c_str);console.log(str); }
...
function getHost() { var terminalDataUrl = 'ws://' + window.location.host + '/terminal/data'; var length = lengthBytesUTF8(terminalDataUrl) + 1; var buffer = _malloc(length); stringToUTF8(terminalDataUrl, buffer, length + 1); return buffer; }
...
var ___start_em_js = Module['___start_em_js'] = 245460;
var ___stop_em_js = Module['___stop_em_js'] = 246230;
