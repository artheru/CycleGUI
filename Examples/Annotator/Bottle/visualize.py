...
if __name__ == "__main__":
    ...
    for data in data_list:
        ...
        vertices_array = np.asarray(conceptualization_rendering.vertices).flatten()
        ...
        # else:
        o3d.visualization.draw_geometries([conceptualization_rendering, coord_frame])
