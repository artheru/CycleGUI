...
TEMPLATES = {
    "Standard_Sphere": Standard_Sphere,
    "Semi_Ring_Bracket": Semi_Ring_Bracket,
    "Tilted_Bracket": Tilted_Bracket,
    "Enclosed_Bracket": Enclosed_Bracket,
    "Cylindrical_Base": Cylindrical_Base,
    "Cuboidal_Base": Cuboidal_Base,
    "Star_Shaped_Base": Star_Shaped_Base,
    "Special_Base": Special_Base,
    "Table_Like_Base": Table_Like_Base,
}
...
class ConceptualAssembly:
    ...
    #     """
    #     Filter the provided parameters to match the constructor of the template class.
    #     """
